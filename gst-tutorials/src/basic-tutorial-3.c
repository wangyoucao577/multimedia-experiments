...
main (int argc, char *argv[])
{
  ...
  if (!data.pipeline || !data.source || !data.audio_convert || !data.resample
      || !data.video_sink || !data.video_convert || !data.audio_sink) {
  ...
  gst_bin_add_many (GST_BIN (data.pipeline), data.source, data.audio_convert,
      data.resample, data.audio_sink, data.video_convert, data.video_sink, NULL);
  if (!gst_element_link_many (data.audio_convert, data.resample, data.audio_sink, NULL) || !gst_element_link_many (data.video_convert, data.video_sink, NULL)) {
